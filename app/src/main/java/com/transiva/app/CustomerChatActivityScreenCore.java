...
class CustomerChatActivityScreenCore extends Activity {
    ...
    protected static final String IMAGE_V2_PREFIX =
            "[[IMAGE2]]";

    protected final Handler mainHandler =
            new Handler(Looper.getMainLooper());

    protected final List<JSONObject> conversations =
            new ArrayList<>();
    ...
    protected View conversationCard(
            JSONObject item
    ) {
        boolean history =
                item.optBoolean(
    ...
    protected View buildLastMessagePreview(
            JSONObject item,
            String participant,
            boolean history
    ) {
    ...
    protected boolean isImageMessage(
            String message
    ) {
        String value =
                message == null
    ...
    protected boolean isLastMessageMine(
            JSONObject item
    ) {
        if (
                item.optBoolean(
