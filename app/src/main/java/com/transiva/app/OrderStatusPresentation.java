...
public final class OrderStatusPresentation {
    ...
    public static String label(String rawStatus, String rawType) {
        ...
        switch (s) {
            ...
            case "taken": case "accepted": case "driver_accepted": case "assigned": case "taken_by_driver": return "Driver Menuju Penjemputan";
    ...
    public static String description(JSONObject o) {
        ...
        switch(s){
            ...
            case "taken": case "accepted": case "driver_accepted": case "assigned": case "taken_by_driver": return isFood(t)?d+" sedang menuju restoran":d+" sedang menuju titik penjemputan";
