...
public class PassengerTransportActivity extends Activity {

    protected boolean isCarService() { return false; }
    private String serviceName() { return isCarService() ? "Transcar" : "TransRide"; }
    private String offerService() { return isCarService() ? "TransCar" : "TransRide"; }
    private String driverType() { return isCarService() ? "car" : "bike"; }
    private String serviceTitle() { return isCarService() ? "Transcar" : "TransRide"; }
