...
class RepeatFoodOrderActivityScreenCore extends FragmentActivity {
    ...
    protected static final String CREATE_FOOD_URL =
            BASE_URL + "server/create_food_order.php";

    protected RepeatOrderData data;

    protected LinearLayout menuBox;
    protected TextView restaurantTitle;
    protected TextView totalText;
    protected ProgressBar loading;

    protected final Map<Integer, JSONObject> menuMap =
            new LinkedHashMap<>();

    protected final Map<Integer, Integer> quantities =
            new LinkedHashMap<>();
    ...
    protected ScrollView buildScreen() {
    ...
    protected void loadRestaurantMenus() {
    ...
    protected void restoreMenus(JSONArray menus) {
        menuMap.clear();
        quantities.clear();
    ...
    protected void addUnavailableCard(
            JSONObject old
    ) {
    ...
    protected void confirmFoodOrder() {
    ...
    protected JSONArray selectedItems() {
    ...
    protected void submitFoodOrder(
            JSONArray items
    ) {
    ...
    protected void submitFoodOrderAuthorized(
            JSONArray items
    ) {
        if (submitting) {
            return;
    ...
    protected void showFatal(String message) {
        menuBox.removeAllViews();
        menuBox.addView(statusCard(message));
    }

    protected Button miniButton(String value) {
