...
public final class TransAssistantKnowledge {
    ...
    private static List<Entry> defaults(){ArrayList<Entry>x=new ArrayList<>();
        ...
        x.add(e("shop","ORDER_SHOP","TransShop",new String[]{"Untuk membeli atau menitip belanja barang, gunakan TransShop. Pilih barang atau toko, tentukan tujuan, lalu konfirmasi."},"OPEN_SHOP","Buka TransShop",80,new String[]{"pesan barang","mau belanja","titip belanja","beli barang","beli obat","pesan obat","beli obat di apotek","mau beli obat","butuh obat"},new String[]{"transshop","belanja","shop","obat","apotek","toko"},new String[]{"kirim barang yang sudah ada"},new String[]{"mau pesan barang"}));
