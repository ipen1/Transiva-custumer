...
public class TransShopActivity extends Activity {
    ...
    private static final String PROFILE_URL = BASE_URL + "server/get_customer_profile.php";
    ...
    private String pickupAddress = "Lokasi Belanja";
    ...
    private String mapHtml() {
        ...
        return "<!DOCTYPE html><html><head>" +
                ...
                "function setPickup(lat,lng,label){lat=+lat;lng=+lng;if(!lat||!lng)return;if(pickup)pickup.setLngLat([lng,lat]);else pickup=newMarker(lat,lng,pickupIconData,'🟢'," + MARKER_BOX_WIDTH_DP + "," + MARKER_BOX_HEIGHT_DP + ",'bottom');if(label)pickup.setPopup(popup('<div class=popup><b>Lokasi Belanja</b><br>'+esc(label)+'</div>'));}" +
