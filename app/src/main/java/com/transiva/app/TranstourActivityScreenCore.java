...
class TranstourActivityScreenCore extends Activity {
    ...
    protected static final int PICK_PROOF = 7721;

    protected final Handler mainHandler = new Handler(Looper.getMainLooper());
    protected final List<JSONObject> wisataPlaces = new ArrayList<>();
    protected final List<JSONObject> tickets = new ArrayList<>();
    protected final Map<String, Bitmap> imageCache = new HashMap<>();
    ...
    protected JSONObject selectedWisata;
    protected int selectedQty = 1;
    protected Uri selectedProofUri;
    protected String selectedProofName = "bukti_transfer.jpg";
    protected String currentPage = "list";
    protected boolean ticketPollingActive = false;
    protected boolean ticketLoading = false;
    protected AlertDialog barcodeDialog;
    protected String openedBarcodeTicketCode = "";
    protected String ticketNoticeMessage = "";

    protected final Runnable ticketPollingRunnable = new Runnable() {
    ...
    protected void renderWisataList() {
        for (JSONObject w : wisataPlaces) addWisataCard(w);
    }

    protected void addWisataCard(JSONObject w) {
    ...
    protected void startTicketPolling() {
    ...
    protected void stopTicketPolling() {
        ticketPollingActive = false;
        mainHandler.removeCallbacks(ticketPollingRunnable);
    }

    protected void renderTickets() {
        removeViewsAfter(2);
    ...
    protected void addClaimNotice(String message) {
    ...
    protected void addTicketCard(JSONObject t) {
    ...
    protected void showBarcodeDialog(String ticketCode, String securityCode) {
