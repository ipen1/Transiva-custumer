...
public class UpdateDownloadActivity extends Activity {
    ...
    private void verifyApk(File apk) throws Exception {
        ...
        if (!AppUpdateClient.CUSTOMER_PACKAGE.equals(archive.packageName)) {
            throw new SecurityException("APK bukan paket Transiva Customer.");
        }
    ...
    @Override public void onBackPressed() {
        if (forcedMode) {
            Toast.makeText(this, "Pembaruan wajib dipasang untuk menggunakan Transiva Customer.", Toast.LENGTH_SHORT).show();
            return;
        }
