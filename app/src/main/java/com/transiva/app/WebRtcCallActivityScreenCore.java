...
class WebRtcCallActivityScreenCore extends Activity {


    protected static final int REQ_MIC = 7101;
    protected static final long POLL_CONNECTING_MS = 900L;
    protected static final long POLL_CONNECTED_MS = 2500L;
